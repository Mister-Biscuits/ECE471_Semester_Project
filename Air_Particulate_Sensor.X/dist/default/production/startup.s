	...
	; Compiler options:
	;
	; -q --opt=none --chip=16lf15375 \
	; -Mdist/default/production/Air_Particulate_Sensor.X.production.map \
	; -DXPRJ_default=default -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=E:/MPXLab/IDE/packs/Microchip/PIC16F1xxxx_DFP/1.26.410/xc8 \
	...
	; -oAir_Particulate_Sensor.X.production.elf \
	; --objdir=dist/default/production --outdir=dist/default/production \
	; build/default/production/mcc_generated_files/i2c_host/src/mssp1.p1 \
	...
	; build/default/production/Main.p1 build/default/production/oled.p1 \
	; build/default/production/sgp30_sensor.p1 \
	; build/default/production/I2C.p1 -L--fixupoverflow=error --rors \
	; --icl=auto --callgraph=none --errformat=%f:%l:%c: error: (%n) %s \
