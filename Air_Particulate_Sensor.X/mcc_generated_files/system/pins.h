 ...
 * 
 * MODIFIED: Fixed I2C_SDA / I2C_SCL aliases to match actual wiring:
 *           RC4 = SDA (pin 23), RC5 = SCL (pin 24)
*/
...
// get/set IO_RB0 aliases  (OLED SPI bit-bang SDO)
...
// get/set IO_RB1 aliases  (OLED SPI bit-bang SCK)
...
// get/set IO_RC4 aliases  (I2C SDA - pin 23)
// FIXED: was incorrectly labelled I2C_SCL, now correctly I2C_SDA
...
// get/set IO_RC5 aliases  (I2C SCL - pin 24)
// FIXED: was incorrectly labelled I2C_SDA, now correctly I2C_SCL
...
#define I2C_SCL_OD                   ODCONCbits.ODCC5
#define I2C_SCL_ANS                  ANSELCbits.ANSC5
...
#define I2C_SCL_SetPushPull()        do { ODCONCbits.ODCC5 = 0; } while(0)
#define I2C_SCL_SetOpenDrain()       do { ODCONCbits.ODCC5 = 1; } while(0)
#define I2C_SCL_SetAnalogMode()      do { ANSELCbits.ANSC5 = 1; } while(0)
#define I2C_SCL_SetDigitalMode()     do { ANSELCbits.ANSC5 = 0; } while(0)

// get/set IO_RC7 aliases  (OLED SPI CS)
