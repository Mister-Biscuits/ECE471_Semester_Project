...
static void blink_error(uint8_t count)
{
    while (1) {
        ...
        _delay((unsigned long)((800)*(32000000U/4000.0)));
    }
}
...
static I2C_Status sgp30_probe(void)
{
    ...
    s = I2C_HW_SendByte((uint8_t)(((unsigned)0x58u << 1u) & 0xFEu));
    I2C_HW_Stop();
    return s;
}
...
int main(void){
    ...
    I2C_HW_Init(((uint8_t)(((32000000UL) / (4UL * (100000UL))) - 1UL)));
